...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('postperiode', [AdminController::class, 'postperiode'])->name('postperiode');
    Route::get('hapusperiode/{id}', [AdminController::class, 'hapusperiode'])->name('hapusperiode');
